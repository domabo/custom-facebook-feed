...
//Translate
  ...
  //Separating Line
    ...
    //ALL EVENTS
    $cff_posts_json_url = 'https://graph.facebook.com/' . $page_id . '/' . $graph_query . '?since=today&until=20+days&access_token=' . $access_token . '&limit=' . $cff_post_limit . '&locale=' . $cff_locale . $cff_ssl;
